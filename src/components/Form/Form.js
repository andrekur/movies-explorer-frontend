...
function Form({title, onSubmit, children, submitButtonText, additionalText, additionalLinkText, additionalLink, isValid, isWaitingResponse}) {
  return (
    <div className="form">
      <Logo/>
      ...
      <div className="form__additional">
        ...
        <a className="form__additional-link" href={ additionalLink }>{ additionalLinkText }</a>
      </div>
    </div>
  )
}
